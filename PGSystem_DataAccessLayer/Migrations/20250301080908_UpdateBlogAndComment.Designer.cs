...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250301080908_UpdateBlogAndComment")]
    partial class UpdateBlogAndComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 3, 1, 15, 9, 8, 39, DateTimeKind.Local).AddTicks(2582)
                        });
                });
