...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250207153931_UpdateEntity")]
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 2, 7, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 2, 7, 22, 39, 30, 247, DateTimeKind.Local).AddTicks(8659)
                        });
                });
