...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250305093128_UpdateMemberAndUsers")]
    partial class UpdateMemberAndUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 3, 5, 16, 31, 28, 292, DateTimeKind.Local).AddTicks(6420)
                        });
                });
