...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250305084445_IsDeleted_For_Members")]
    partial class IsDeleted_For_Members
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            FullName = "Admin dep trai",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 3, 5, 15, 44, 45, 246, DateTimeKind.Local).AddTicks(4486)
                        });
                });
