...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250116195223_AdminData")]
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 1, 17, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 1, 17, 2, 52, 22, 654, DateTimeKind.Local).AddTicks(9955)
                        });
                });
