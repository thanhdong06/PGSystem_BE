...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250319091254_FixConflict")]
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 3, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            FullName = "Admin dep trai",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 3, 19, 16, 12, 53, 807, DateTimeKind.Local).AddTicks(9107)
                        });
                });
