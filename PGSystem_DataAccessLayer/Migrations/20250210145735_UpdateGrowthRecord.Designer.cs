...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250210145735_UpdateGrowthRecord")]
    partial class UpdateGrowthRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 2, 10, 21, 57, 35, 259, DateTimeKind.Local).AddTicks(2109)
                        });
                });
