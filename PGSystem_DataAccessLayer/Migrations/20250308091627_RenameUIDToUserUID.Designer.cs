...
namespace PGSystem_DataAccessLayer.Migrations
{
    ...
    [Migration("20250308091627_RenameUIDToUserUID")]
    partial class RenameUIDToUserUID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UID = 1,
                            CreateAt = new DateTime(2025, 3, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "admin@gmail.com",
                            FullName = "Admin dep trai",
                            Password = "12345",
                            Phone = "0123456789",
                            Role = "Admin",
                            UpdateAt = new DateTime(2025, 3, 8, 16, 16, 26, 617, DateTimeKind.Local).AddTicks(3815)
                        });
                });
            ...
            modelBuilder.Entity("PGSystem_DataAccessLayer.Entities.Member", b =>
                {
                    ...
                    b.HasOne("PGSystem_DataAccessLayer.Entities.User", "User")
                        .WithOne("Member")
                        .HasForeignKey("PGSystem_DataAccessLayer.Entities.Member", "UserUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
